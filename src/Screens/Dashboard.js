...
import FabComponent from '../Componets/FabComponent/FabComponent';
export default function Dashboard() {
  return (
    <>
      <View style={styles.container}>
        <DashboardHeader img={require('../Assets/Images/university.jpg')} title={'Bhanu'} headerContainerStyle={{ backgroundColor: colors.PRIMARY, paddingHorizontal: 8, elevation: 5, borderBottomLeftRadius: 8, borderBottomRightRadius: 8 }} />
        <ScrollView>
          <Slider />
          {/* Boxes */}
